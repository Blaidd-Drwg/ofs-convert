...
void visualizer_add_block_range(BlockRange source) {
    ...
    printf("visualizer_add_block_range %d %d\n", block_range->begin, block_range->length);
}
...
void visualizer_render_to_file(const char* path, uint32_t block_count) {
    ...
    fprintf(output, "<svg viewBox=\"0 0 %d 100\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" xml:space=\"preserve\">\n", bar_width);
